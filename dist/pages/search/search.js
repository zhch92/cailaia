	...
	Page({
	    ...
	    onShow: function onShow() {
	        ...
	        if (arr.length > 0) {
	            this.setData({
	                searchHint: false,
	                history: [].concat((0, _toConsumableArray3.default)(arr))
	            });
	        } else {
	            this.setData({
	                searchHint: true
	    ...
	    bindKeyInput: function bindKeyInput(e) {
	        ...
	        if (val == '') {
	            ...
	            if (val == 600) {
	                this.setData({
	                    searchResult: [].concat((0, _toConsumableArray3.default)(init.data))
	                });
	                // wx.request({
	    ...
	    clearHistory: function clearHistory(e) {
	        ...
	        var newArr = arr.slice(0, indexVal);
	        var newArr1 = arr.slice(indexVal + 1);
	        arr = [].concat((0, _toConsumableArray3.default)(newArr), (0, _toConsumableArray3.default)(newArr1));
	        wx.setStorage({
	            key: "history",
	            data: arr
	        });
	    ...
	    clearHistoryAll: function clearHistoryAll(e) {
	        wx.clearStorage();
	        this.setData({
	            searchHint: true
	    ...
	    bindSkip: function bindSkip(e) {
	        var $dom = e.target;
	        var id = $dom.dataset.id;
	        var prodName = $dom.dataset.name;
	        var prodCode = $dom.dataset.code;
	        var obj = { 'id': id, 'prodName': prodName, 'prodCode': prodCode };
	        var idArr = [];
	        ...
	        if (arr.length > 10) {
	            arr = [].concat((0, _toConsumableArray3.default)(arr.slice(0, 9)));
	        }
	        wx.setStorage({
	            key: "history",
	            data: arr
